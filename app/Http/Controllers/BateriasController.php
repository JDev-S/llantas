...
public function agregar_sucursales_bateria($aBateria)
    ...
    public function actualizar_Bateria(Request $input)
    {    
        $nombre_bateria = $input['update_nombre_bateria'];
        $precio = $input['update_precio'];
        $marca=$input['update_marca'];
        $modelo=$input['update_modelo'];
        $voltaje=$input['update_voltaje'];
        $capacidad_arranque=$input['update_capacidad'];
        $capacidad_arranque_frio=$input['update_frio'];
        $medidas=$input['update_medidas'];
        $peso=$input['update_peso'];
        $tamanio=$input['update_tamanio'];
        $id_producto=$input['update_id_bateria'];
         $check2=$input['check2'];
        $nuevo2=$input['nuevo2'];
        ...
        if($input->hasFile('fotografia_miniatura'))
        {
            ...
            $ingresar=DB::select('call actualizar_producto_universal(?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ?, ?, ?, ?, ? )',[$id_producto,$nombre_bateria,$precio,2,$marca,$foto,$modelo,'','','','',$voltaje,$capacidad_arranque,$capacidad_arranque_frio,$medidas,$peso,$tamanio]);
        ...
        else
        {
           ...
           $ingresar=DB::select('call actualizar_producto_universal(?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ?, ?, ?, ?, ? )',[$id_producto,$nombre_bateria,$precio,2,$marca,$fotografia_miniatura,$modelo,'','','','',$voltaje,$capacidad_arranque,$capacidad_arranque_frio,$medidas,$peso,$tamanio]);
        }
