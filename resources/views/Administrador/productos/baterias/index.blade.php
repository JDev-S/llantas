                ...
                <div class="ccard h-100 d-flex flex-column mx-2 px-2 py-3">
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="update_nombre_bateria" name="update_nombre_bateria" placeholder="Codigo de batería">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="modelo">Modelo</label>
                    ...
                    <div class="form-row align-items-center col-md-12">
                        <div class="form-group col-md-6">
                            <label for="rin">Voltaje</label>
                            <input type="text" class="form-control" id="update_voltaje" name="update_voltaje" placeholder="Voltaje">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="medida">Capacidad de arranque</label>
                            <input type="text" class="form-control" id="update_capacidad" name="update_capacidad" placeholder="Cpacidad de arranque">
                        </div>
                    </div>
                    ...
                    <div class="form-row align-items-center col-md-12">
                        <div class="form-group col-md-6">
                            <label for="rin">Capacidad de arranque en frio</label>
                            <input type="text" class="form-control" id="update_frio" name="update_frio" placeholder="Capacidad de arranque en frío">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="medida">Medidas</label>
                            <input type="text" class="form-control" id="update_medidas" name="update_medidas" placeholder="Medidas">
                        </div>
                    </div>
                    ...
                    <div class="form-row align-items-center col-md-12">
                        <div class="form-group col-md-6">
                            <label for="rin">Peso</label>
                            <input type="text" class="form-control" id="update_peso" name="update_peso" placeholder="Peso">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="medida">Tamaño</label>
                            <input type="text" class="form-control" id="update_tamanio" name="update_tamanio" placeholder="Tamaño">
                        </div>
                    </div>
